...
public class ReviewController {
    ...
    public void deleteUser(@PathVariable Long reviewId) {
        service.deleteReviewById(reviewId);
    }
    @DeleteMapping("delete_review_by_date/{datePosted}")
    public void deleteReview(@PathVariable Date datePosted) {
        service.deleteReviewByDate(datePosted);
    }
}
