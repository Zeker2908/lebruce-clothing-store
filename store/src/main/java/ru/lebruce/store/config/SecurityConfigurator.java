...
import ru.lebruce.store.security.TokenFilter;
...
public class SecurityConfigurator {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                //todo
                //Нормально настроить корс, чтобы была разрешена работа только с нашим фронт эндом
                ...
                .authorizeHttpRequests(authorize ->authorize
                        ...
                        //todo
                        //Добавить остальные запросы, которые нуждаются в авторизации пользователя
                        //и в их контроллерах добавить /secured
